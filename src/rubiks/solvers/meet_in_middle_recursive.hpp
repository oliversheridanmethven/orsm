...
#include "rubiks/solvers/solver.hpp"
#include <algorithm>
#include <execution>
    ...
    namespace solvers
    {
        ...
        private:
            ...
            static auto intermediate_shape_and_turns(const Shape &start, const Shape &target)
            {
                ...
                CHECK_GE(turns_from_start, turns_from_target) << "We expect equal or more turns from the starting shape than from the target.";
